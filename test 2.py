...
function main()
    ...
    while choice is difference "Q"
        if choice is "W"
            day, random_rainfall =  simulate_a_day(day)
...
function simulate_a_day(day)
    day = day + 1
    random_rainfall = random between 0 and 128 mm
    return day, random_rainfall
...
def simulate_a_day(day):
    """Simulate passing of one day"""
    day += 1  # add one day
